...
Copyright (c) 2020 OneFi <https://onefi.io>
...
contract OneFiToken is Context, ERC20 {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        require(available[sender] >= allowance(sender, msg.sender).sub(amount), "Insufficient available funds amount.");
    ...
    function increaseAllowance(address spender, uint256 addedValue) public override returns (bool) {
        ...
        require(available[spender] >= allowance(msg.sender, spender).add(addedValue), "Insufficient available funds amount.");
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public override returns (bool) {
        ...
        if(available[spender] < allowance(msg.sender, spender).sub(subtractedValue)) {
